        ...
        <div id="main" style="margin-top:10px">
            <div id="head" style="width:100%;height: 70px;font-size:x-small;margin: 0 auto">
                ...
                <div style="float: right;height: 50px" class="col-md-2">
                    <div style="margin:25px 0px 0px 10px;float: left"><img src="<%=request.getContextPath() %>/img/magnifier.png" height="35px" width="35px"/></div>
                    <div style="margin:25px 0px 0px 20px;float: left"><img src="<%=request.getContextPath() %>/img/downward.png" height="35" width="35"/></div>
                </div>
            </div>
