...
/*{"k":"1.1.14","auto_updating":true,"last_published":"2017-06-02 13:37:42 UTC"}*/
(function (config) {
    (function () {
        'use strict';
        var f, g = [];
    ...
    (function () {
        ...
        var Ba = null, Ca = null, Da = null, Ea = null;

        function Fa() {
            if (null === Ca)if (Ga() && /Apple/.test(window.navigator.vendor)) {
                var a = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))(?:\.([0-9]+))/.exec(window.navigator.userAgent);
                Ca = !!a && 603 > parseInt(a[1], 10)
            } else Ca = !1;
            return Ca
        }

        function Ga() {
            null === Ea && (Ea = !!document.fonts);
            return Ea
        }
        ...
        function G(a, b) {
            return [a.style, a.weight, Ha() ? a.stretch : "", "100px", b].join(" ")
        }
            ...
            return new Promise(function (a, b) {
                if (Ga() && !Fa()) {
                    ...
                    function g() {
                        var b;
                        if (b =
                                -1 != q && -1 != u || -1 != q && -1 != k || -1 != u && -1 != k) (b = q != u && q != k && u != k) || (null === Ba && (b = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent), Ba = !!b && (536 > parseInt(b[1], 10) || 536 === parseInt(b[1], 10) && 11 >= parseInt(b[2], 10))), b = Ba && (q == t && u == t && k == t || q == da && u == da && k == da || q == ea && u == ea && k == ea)), b = !b;
                    ...
                    var n = new xa(d), p = new xa(d), w = new xa(d), q = -1, u = -1, k = -1, t = -1, da = -1, ea = -1,
        ...
        function Ja() {
            if (!Ia) {
                ...
                b.appendChild(a);
                Ia = (new Aa("_fff_", {})).load("@", 5E3).then(function () {
        ...
        La.prototype.arrayBuffer = function () {
            return Promise.resolve(this.body)
        };
        var Ma = !(window.XDomainRequest && !("responseType" in XMLHttpRequest.prototype));
        ...
        function Na(a) {
            ...
            return new Promise(function (c, d) {
                if (Ma) {
                    ...
                    e.onload = function () {
                        c(new La(e.response, {status: e.status, statusText: e.statusText}))
                    };
                    e.onerror = function () {
                    ...
                    e.onload = function () {
                        c(new La(e.responseText, {status: e.status, statusText: e.statusText}))
                    }, e.onerror = function () {
                    d(new TypeError("Network request failed"))
                }, setTimeout(function () {
                    e.send(null)
        ...
        function Oa(a, b, c) {
            ...
            "string" === typeof b ? this.b = Ka(b) : (this.i = b, this.o = "loaded", this.A(d))
        }
        ...
        Oa.prototype.load = function () {
            var a = this;
            "unloaded" === a.o && (a.o = "loading", Ja().then(function (b) {
                (b = Pa(a, b)) ? Na(b).then(function (a) {
        ...
        if (window.FontFace) J = window.FontFace, J.prototype.load = window.FontFace.prototype.load, K = document.fonts; else {
            var J = Oa;
            J.prototype.load = Oa.prototype.load;
            var K = new I
        }
        ;
        function L(a, b) {
        ...
        Ua.prototype.add = function (a) {
            ...
            for (var b = "number" === typeof a, c = 0; c < this.g; c++)this.b.set(b ? Ra(a, M[c]) % this.size : Sa(a, M[c]) % this.size)
        };
        Ua.prototype.has = function (a) {
            if ("string" !== typeof a && "number" !== typeof a)throw Error("Value should be a string or number.");
            for (var b = "number" === typeof a, c = 0; c < this.g; c++)if (!this.b.has(b ? Ra(a, M[c]) % this.size : Sa(a, M[c]) % this.size))return !1;
            return !0
        };
        function Va(a) {
        ...
        function Wa(a) {
            var b = Math.min(Math.ceil(Math.log(.01) * (a.unicode.length || 1) / Math.log(1 / Math.pow(2, Math.log(2)))), 9586),
                c = new Ua(b, Math.max(Math.min(Math.round(Math.log(2) * b / (a.unicode.length || 1)), M.length), 1));
        ...
        function Ya() {
            ...
            a:for (; 64 > a; b++) {
                ...
                8 > a && (this.b[a] = Za(Math.pow(b, .5)));
                this.g[a] = Za(Math.pow(b, 1 / 3));
                a++
            }
        }
        ...
        var $a = !(window.XDomainRequest && !("responseType" in XMLHttpRequest.prototype));
        ...
        function cb(a) {
            var b = db(a);
            bb[b] || (bb[b] = Q("https://primer.typekit.net/primer/" + db(a), {
                method: "POST",
        ...
        function eb(a) {
            ...
            return b = a.b ? b + ("&dyna=" + encodeURIComponent(fb(a))) : b + ("&features=" + encodeURIComponent(gb(a)))
        }

        function db(a) {
            if (null === a.g) {
                var b = {version: "1.0", unicode: a.unicode.join(",")};
                a.b ? b.dyna = fb(a) : b.features = gb(a);
                for (var c = new Ya, d = JSON.stringify(b), b = c.g.slice(0), c = c.b.slice(0), d = d + String.fromCharCode(128), e = Math.ceil((d.length / 4 + 2) / 16), f = Array(e), h = 0; h < e; h++) {
                    f[h] = Array(16);
        ...
        var X = W({type: T, I: S, C: S, i: S, A: S}), Y = W({tag: jb, b: T, offset: T, length: T});
        ...
        function mb(a, b) {
            ...
            c = 2981146554 - kb(new DataView(d));
        ...
        var pb = W({offset: T, D: T, J: T});
        ob.prototype.apply = function (a) {
            if (1 === this.type || 2 === this.type) V(this.b, new DataView(a.buffer, a.byteOffset + this.offset, this.b.byteLength)); else if (3 === this.type) {
                ...
                V(c, d)
            } else if (4 === this.type)for (var c = new R(this.b), e = hb(c, pb, this.b.byteLength / pb.u), b = 0; b < e.length; b++)c = new DataView(a.buffer, a.byteOffset + e[b].offset, e[b].D),
        ...
        function qb(a) {
            ...
            this.g = {};
            this.i = [];
            this.status = this.b.read(ib);
            if (0 === this.status) {
                this.b.b = 10;
                for (var b = hb(this.b, rb, this.b.read(S)), c = 0; c < b.length; c++) {
                    var d = new nb(b[c].tag, b[c].length);
                    this.i.push(d);
                    this.g[b[c].tag] = d
                }
                b = this.b.read(S);
                for (c = 0; c < b; c++)for (var e = this.b.read(sb), d = this.g[e.tag], f = 0; f < e.H; f++) {
                    var h = this.b.read(tb), g = new DataView(a, this.b.b, h.length);
                    d.F.push(new ob(h.type, h.offset, g));
                    this.b.b += h.length
                }
            }
        }

        var rb = W({tag: jb, g: T, offset: T, length: T}), sb = W({tag: jb, K: ib, m: T, H: S}),
            tb = W({type: ib, offset: T, length: T});
        var ub = !!window.ArrayBuffer;

        function vb(a, b, c) {
            var d = c || {};
            this.url = new ua(b);
            this.unicode = new m(ba(d.unicodeRange || ""));
            this.g = new sa(ra(d.featureSettings || ""));
            delete d.featureSettings;
            this.subset = new N(r(this.unicode), ta(this.g));
            this.source = wb(this, this.subset);
        ...
        function yb(a, b) {
            ...
            var d = null, d = b.b ? new ab(b.unicode, null, a.b.b[1146703425]) : new ab(b.unicode, b.g), c = db(d),
                e = E(a.url, {format: "m", primer: c});
            return Q(e).then(function (a) {
                return 200 === a.status ? a.body : cb(d).then(function () {
                    return Q(e).then(function (a) {
                        if (200 === a.status)return a.body;
                        throw a;
                    })
        ...
        vb.prototype.load = function () {
            var a = this;
            a.A || (a.A = new Promise(function (b, c) {
                ub ? a.dynamic && "unloaded" === a.o ? (a.o = "loading", yb(a, a.subset).then(function (b) {
                    a.b = new lb(b);
                    b = a.b;
                    var c;
                    ...
                    c = new qb(c.buffer);
                    mb(b, c);
                    a.w = new J(a.family, (new DataView(a.b.arrayBuffer)).buffer, xb(a));
                    return a.w.load()
                }).then(function () {
                    a.o = "loaded";
                    b(a)
        ...
        vb.prototype.update = function (a) {
            ...
            b.i = b.i.then(function () {
                ...
                return "unloaded" === b.o ? Promise.resolve(b) : b.load().then(function () {
                    if (ub) {
                        if (b.b instanceof lb) {
                            var a = b.b, c = new N(r(d), null, a.b[1195661646]);
                            return yb(b, c).then(function (d) {
                                d = new qb(d);
                                if (0 === d.status)return mb(a, d), b.subset =
                                    c, b.b = a, b.w = new J(b.family, (new DataView(b.b.arrayBuffer)).buffer, xb(b)), b.w.load().then(function () {
                                    K.add(b.w);
                                    return b
                                });
                                b.subset = c;
                    ...
                    b.subset = c;
                    b.source = wb(b, c);
                    b.w = new J(b.family, b.source, xb(b));
                    K.add(b.w);
                    return b
                })
            });
        ...
        function Cb(a) {
            ...
            a.f && (a.f.forEach(function (a) {
                this.B.push(new vb(a.family, a.source, a.descriptors))
            }, this), a.ping && Ab(this.ping, a.f.map(function (a) {
                return a.id
            })))
        }
        ...
        var Fb = new Cb(config);
        window.Typekit = {};
        window.Typekit.load = Fb.load.bind(Fb);
        window.Typekit.fonts = Fb.fonts;
        window.Typekit.kit = Fb.B;
    ...
    "p": 1,
    "j": "1.1.14",
    "c": [".tk-source-han-sans-simplified-c", "\"source-han-sans-simplified-c\",sans-serif"],
    "l": "typekit",
    "type": "dynamic",
    ...
    "dl": "AAAALAAAAAppW0lRAAAPWg",
    "f": [{
        "source": "https://use.typekit.net/af/e381ce/000000000000000000017733/27/{format}{?primer,unicode,gdyn,features,v}",
        "id": 23605,
        "dynamic": true,
        "family": "source-han-sans-simplified-c",
        "descriptors": {
            "weight": 700,
        ...
        "source": "https://use.typekit.net/af/36b240/000000000000000000017734/27/{format}{?primer,unicode,gdyn,features,v}",
        "id": 23606,
        "dynamic": true,
        "family": "source-han-sans-simplified-c",
        "descriptors": {
        ...
        "source": "https://use.typekit.net/af/29d181/000000000000000000017735/27/{format}{?primer,unicode,gdyn,features,v}",
        "id": 23607,
        "dynamic": true,
        "family": "source-han-sans-simplified-c",
        "descriptors": {
        ...
        "source": "https://use.typekit.net/af/5824e2/000000000000000000017736/27/{format}{?primer,unicode,gdyn,features,v}",
        "id": 23608,
        "dynamic": true,
        "family": "source-han-sans-simplified-c",
        "descriptors": {
        ...
        "source": "https://use.typekit.net/af/25af3f/000000000000000000017737/27/{format}{?primer,unicode,gdyn,features,v}",
        "id": 23609,
        "dynamic": true,
        "family": "source-han-sans-simplified-c",
        "descriptors": {
        ...
        "source": "https://use.typekit.net/af/b520e4/000000000000000000017738/27/{format}{?primer,unicode,gdyn,features,v}",
        "id": 23610,
        "dynamic": true,
        "family": "source-han-sans-simplified-c",
        "descriptors": {
        ...
        "source": "https://use.typekit.net/af/5468a3/000000000000000000017739/27/{format}{?primer,unicode,gdyn,features,v}",
        "id": 23611,
        "dynamic": true,
        "family": "source-han-sans-simplified-c",
        "descriptors": {
